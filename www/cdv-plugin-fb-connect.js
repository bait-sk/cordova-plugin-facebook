...
CDV.FB = {
  init: function(apiKey, fail) {
    ...
    xmlhttp.onload=function(){console.log("FB: Endpoint saved "+ this.responseText);}
    ...
    if (authResponse && authResponse.expirationTime) { 
      ...
      console.log('FB: Cordova Facebook Connect plugin initialized successfully.');
    }, (fail?fail:null), 'Facebook', 'init', [apiKey]);
  },
  login: function(params, cb, fail) {
    ...
    cordova.exec(function(e) { // login
        ...
        if (cb) cb(e);
    }, (fail?fail:null), 'Facebook', 'login', params.scope.split(',') );
  },
  logout: function(cb, fail) {
    cordova.exec(function(e) {
      ...
      if (cb) cb(e);
    }, (fail?fail:null), 'Facebook', 'logout', []);
  },
  getLoginStatus: function(cb, fail) {
    cordova.exec(function(e) {
      if (cb) cb(e);
    }, (fail?fail:null), 'Facebook', 'getLoginStatus', []);
  },
  dialog: function(params, cb, fail) {
    cordova.exec(function(e) { // login
      if (cb) cb(e);
                  }, (fail?fail:null), 'Facebook', 'showDialog', [params] );
  }
};
